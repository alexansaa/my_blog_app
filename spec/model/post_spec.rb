...
RSpec.describe Post, type: :model do
  ...
  it 'returns the most recent comments' do
    comments1 = subject.comments.create(user: tmpUser, text: 'comment text')
    comments2 = subject.comments.create(user: tmpUser, text: 'comment text')
    comments3 = subject.comments.create(user: tmpUser, text: 'comment text')
    comments4 = subject.comments.create(user: tmpUser, text: 'comment text')
    comments5 = subject.comments.create(user: tmpUser, text: 'comment text')
  ...
  it 'returns the 5 most recent posts, even if there are more' do
    ...
    comments4 = subject.comments.create(user: tmpUser, text: 'comment text')
    comments5 = subject.comments.create(user: tmpUser, text: 'comment text')
    comments6 = subject.comments.create(user: tmpUser, text: 'comment text')
    comments7 = subject.comments.create(user: tmpUser, text: 'comment text')
